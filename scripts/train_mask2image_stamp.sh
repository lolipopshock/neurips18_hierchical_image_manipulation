python train_mask2image.py --dataroot=datasets/stamp_giraffe/ --dataloader cityscape \
  --name cvpr_stamp_giraffe_mask2image --model pix2pixHD_condImg --no_instance \
  ...
  --use_skip --use_output_gate --mask_gan_input --gpu_ids 0
